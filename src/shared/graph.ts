/** biome-ignore-all lint/complexity/noExcessiveCognitiveComplexity: just this one 😭 */
// TODO: get rid of that biome ignore ^^
...
export function shortestValidPath(
	...
	if (unlockedNodes.has(targetNodeId)) {
		return [];
	}

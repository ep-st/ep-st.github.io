...
export default function PerkCount() {
  ...
  return (
    <Card className="bg-card/60 border-border/50 ring-primary/5 hover:ring-primary/10 w-full rounded-xl p-3 ring-1 transition-all duration-300 md:backdrop-blur-md">

/** biome-ignore-all lint/style/noMagicNumbers: uhh this is the magic number definer */

export const SUGGESTED_PERK_LIMITS = [25, 40, 75, 100] as const;
export const DEFAULT_PERK_LIMIT = 75 as const;
...
export const DEBUG_NODE_ID_DOWNSCALE = 0.9 as const;

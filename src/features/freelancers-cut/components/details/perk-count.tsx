...
export function PerkCount() {
	...
	return (
		<Card className="w-full rounded-xl border-border/50 bg-card/60 p-3 shadow-lg ring-1 ring-primary/5 transition-all duration-300 hover:ring-primary/10 md:backdrop-blur-md">
